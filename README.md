...
- **Repo:** [github.com/coijiryuna/YT-Music-Mod](https://github.com/coijiryuna/YT-Music-Mod)
...
Rifa Music adalah pemutar musik di browser. Cari lagu, buka album dan artis, buat playlist, lihat lirik, atur antrian — semuanya tanpa daftar akun.
...
### [t.me/coijiryuna](https://t.me/coijiryuna)
...
1. Buka **[yt.rifacomputer.my.id](https://yt.rifacomputer.my.id)**
...
Di laptop atau komputer, Rifa Music langsung siap. Buka situsnya, pilih lagu, dan putar — tidak perlu pengaturan tambahan.

### Putar di latar belakang (Android)

Musik tetap jalan saat layar terkunci atau pindah aplikasi, **tanpa mode desktop**.

Buka [yt.rifacomputer.my.id](https://yt.rifacomputer.my.id) di **[Brave Browser](https://play.google.com/store/apps/details?id=com.brave.browser)** — putar lagu, lalu keluar dari tab atau kunci HP. Audio tetap berlanjut.
...
```bash
git clone https://github.com/coijiryuna/YT-Music-Mod.git
cd YT-Music-Mod
npm install
npm start
```
...
Atau di dashboard Vercel: **Import Git Repository** → pilih `coijiryuna/YT-Music-Mod` → Deploy.
...
**[Buka Rifa Music](https://yt.rifacomputer.my.id)** · **[Join Telegram](https://t.me/coijiryuna)** · **[GitHub](https://github.com/coijiryuna/YT-Music-Mod)**
